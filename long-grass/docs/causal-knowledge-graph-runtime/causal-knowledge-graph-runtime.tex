...
\title{Trajectory Based Non-Deterministic Runtime Execution Environments:\\
Execution as Propagation over a Causal Knowledge Graph}

\author{Kundai Farai Sachikonye\\
\small Technical University of Munich\\
\small AIMe Registry for Artficial Intelligence\\
...
The foundational aspect is that a node does not merely name a subtask. It carries the
...
\subsection{Graph Element Definition}
...
\begin{proposition}[Edge generation]
\label{prop:no-edges}
...
\subsection{Node-Module Interface}
...
\subsection{Non Deterministic Trajectory}
...
a chunk executor that judges nothing---instrumented to test one claim. 
